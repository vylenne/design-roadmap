<template>
  <div class="flex relative cursor-pointer" tabindex="0" @blur="open = false">
    <div class="text-gray-700 dark:text-gray-300 rounded w-32 py-2 focus:outline-none flex items-center justify-center"
      @click="open = !open">
    ...
    <div
      ...
      :class="{ hidden: !open }">
      <div v-for="lang in $i18n.locales" :key="lang.code" :value="lang.name"
